...
neritic_oceanic_vector <- rep(c("N-O", "N", "O"), 200)

bentho_pelagic_vector <- c(rep("D", 150),
                   rep("B", 150),
                 rep("P", 150),
                 rep("BP", 150))
...
data_pred$trophic_level <- as.numeric(data_pred$trophic_level)
